...
export default class LineElement extends DocElement {
    ...
    setValue(field, value, elSelector, isShown) {
        ...
        if (field === 'color' || field === 'lineAngle') {
            this.updateStyle();
        }
    }
     ...
     */
    getFields() {
        return ['id', 'containerId', 'x', 'y', 'width', 'height', 'lineAngle', 'color', 'printIf'];
    }
    ...
    updateStyle() {
        ...
        styleProperties['transform'] = 'rotate(' + (this.getValue('lineAngle') || 0) + 'deg)';
        styleProperties['transform-origin'] = '0 0';
        styleProperties['-ms-transform'] = 'rotate(' + (this.getValue('lineAngle') || 0) + 'deg)';
        styleProperties['-ms-transform-origin'] = '0 0';
        styleProperties['-moz-transform'] = 'rotate(' + (this.getValue('lineAngle') || 0) + 'deg)';
        styleProperties['-moz-transform-origin'] = '0 0';
        styleProperties['-webkit-transform'] = 'rotate(' + (this.getValue('lineAngle') || 0) + 'deg)';
        styleProperties['-webkit-transform-origin'] = '0 0';
        styleProperties['-o-transform'] = 'rotate(' + (this.getValue('lineAngle') || 0) + 'deg)';
        styleProperties['-o-transform-origin'] = '0 0';
