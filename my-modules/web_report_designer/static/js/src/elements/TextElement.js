...
export default class TextElement extends DocElement {
    ...
    getFields() {
        return ['id', 'containerId', 'x', 'y', 'width', 'height', 'content', 'eval',
            ...
            'cs_ellipseValue', 'cs_borderAll', 'cs_borderLeft', 'cs_borderTop', 'cs_borderRight', 'cs_borderBottom',
    ...
    updateStyle() {
        ...
        if (style.getValue('ellipseValue')){
            styleProperties['border-radius'] = '50%';
            borderStyleProperties['border-radius'] = '50%';
        }else{
            styleProperties['border-radius'] = '0%';
            borderStyleProperties['border-radius'] = '0%';
        }
