...
export default class FrameElementPanel {
    ...
    render() {
        ...
        elDiv = $('<div id="rbro_frame_element_ellipse_value_row" class="rbroFormRow"></div>');
        elDiv.append(`<label for="rbro_frame_element_ellipse_value">${this.rb.getLabel('frameElementEllipseValue')}:</label>`);
        elFormField = $('<div class="rbroFormField"></div>');
        let elEllipseValue = $(`<input id="rbro_frame_element_ellipse_value" type="checkbox">`)
            .change(event => {
                if (this.rb.getDataObject(this.selectedObjId) !== null) {
                    let cmd = new SetValueCmd(this.selectedObjId,
                        'rbro_frame_element_ellipse_value', 'ellipseValue',
                        elEllipseValue.is(":checked"), SetValueCmd.type.checkbox, this.rb);
                    this.rb.executeCommand(cmd);
                }
            });
    ...
    updateData(data) {
        if (data !== null) {
            ...
            $('#rbro_frame_element_ellipse_value').prop('disabled', false);
            ...
            $('#rbro_frame_element_ellipse_value').prop('checked', data.getValue('ellipseValue'));
            ...
            $('#rbro_frame_element_ellipse_value').prop('disabled', true);
