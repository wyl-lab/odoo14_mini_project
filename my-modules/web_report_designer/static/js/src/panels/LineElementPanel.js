...
export default class LineElementPanel {
    ...
    render() {
        ...
        elDiv.append(`<label for="rbro_line_element_angle">${this.rb.getLabel('styleLineAngle')}:</label>`);
        elFormField = $('<div class="rbroFormField"></div>');
        let elLineAngle = $(`<input id="rbro_line_element_angle">`)
            .on('input', event => {
                if (this.rb.getDataObject(this.getSelectedObjId()) !== null) {
                    let cmd = new SetValueCmd(this.getSelectedObjId(), 'rbro_line_element_angle',
                        'lineAngle', elLineAngle.val(), SetValueCmd.type.text, this.rb);
                    this.rb.executeCommand(cmd);
                }
            });
        utils.setInputDecimal(elLineAngle);
        elFormField.append(elLineAngle);
        elDiv.append(elFormField);
        panel.append(elDiv);
    ...
    updateData(data) {
        if (data !== null) {
            ...
            $('#rbro_line_element_angle').prop('disabled', false);
            ...
            $('#rbro_line_element_angle').val(data.getValue('lineAngle'));
            ...
            $('#rbro_line_element_angle').prop('disabled', true);
