...
from .elements import DocElementBase, PageBreakElement, SectionElement
...
class Container(object):
    ...
    def render_sbpl(self, container_offset_x, container_offset_y, renderer):
        for render_elem in self.doc_elements:
            if isinstance(render_elem, PageBreakElement):
                continue
            if isinstance(render_elem, SectionElement):
                continue
            render_elem.render_sbpl(container_offset_x, container_offset_y, renderer)
